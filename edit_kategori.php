...
{
    global $koneksi;
    $query = "UPDATE kategoribuku SET namaKategori = '$namaKategori' WHERE KatagoriID = '$kategoriID'";
    return mysqli_query($koneksi, $query);
}

// Ambil data dari form jika ada pengiriman POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $kategoriID = $_POST["KatagoriID"];
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($daftarKategori as $kategori) : ?>
                    <tr>
                        <td><?php echo $kategori['KatagoriID']; ?></td>
                        <td>
                            <form method="post">
                                <input type="hidden" name="KatagoriID" values="<?php echo $kategori['KatagoriID']; ?>">
                                <input type="text" name="NamaKategori" values="<?php echo $kategori['NamaKategori']; ?>">
                        </td>
                        <td>
